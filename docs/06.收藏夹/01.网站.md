...
- [TS 中文手册](https://bosens-china.github.io/Typescript-manual/)
...
- [clippy](https://bennettfeely.com/clippy/) 生成 `clip-path`
...
- [JSFiddle](https://jsfiddle.net/) 国内访问慢或资源加载不了，建议使用代理
- [JS Bin](http://jsbin.com/)
- [Jsrun](http://jsrun.net/) JSFiddle 的国内版本
